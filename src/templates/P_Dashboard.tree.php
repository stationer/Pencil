                ...
                <?php if (!empty($Nodes)) : ?>
                    <table class="js-sort-table">
                        ...
                        <tr>
                            <th>Path</th>
                            <th>Content Type</th>
                            <th class="js-sort-date">Published</th>
                            <th>Trashed</th>
                            <th>Featured</th>
                            <th class="js-sort-date">Modified</th>
                        ...
                        <?php foreach ($Nodes as $Node) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php endif; ?>
                                    <a href="/P_Text/add?parentPath=<?= urlencode($Node->path); ?>"><i
                                            data-feather="plus-square">Add Text</i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
