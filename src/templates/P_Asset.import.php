		...
		<div class="content">
			<form action="/P_Asset/import" method="post">
				<table>
					...
					<tr>
                        <th></th>
						<th class="sort" data-sort="component">File Path</th>
						<th class="sort" data-sort="component">MIME Type</th>
                    ...
                    <?php foreach ($fileList as $file): ?>
                        <tr>
                            <td><?php if (empty($file['Asset'])) : ?>
                                    <label><input type="checkbox" name="import[<?= $file['path'] ?>]" title="import <?= $file['path'] ?>"> Import</label>
                                <?php endif; ?>
                            </td>
                            <td><?= $file['path'] ?></td>
                            <td><?= $file['mimetype'] ?></td>
